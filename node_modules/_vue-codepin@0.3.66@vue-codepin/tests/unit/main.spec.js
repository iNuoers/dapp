...
import { SECURE_INPUT_TYPE } from '@/ts/plugin/constants';
import Component from '@/ts/plugin//Component.vue';
...
describe('Component.vue', () => {
    ...
    it('correctly sets secure input type', async () => {
        ...
        refs.forEach((ref) => {
            const cellElement = wrapper.findComponent({ ref }).element;
    ...
    it('correctly sets parent value', () => {
        ...
        const { vm } = mount(Component, { propsData });
        expect(vm.pinCodeComputed).toBe('1234');
    });
});
