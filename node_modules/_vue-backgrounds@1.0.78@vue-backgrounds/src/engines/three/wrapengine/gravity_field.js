...
class Planet extends Particle {
  gravitate(p) {
    if (Particle.prototype.isPrototypeOf(p)) {
      ...
      throw new TypeError("The argument passed to the gravitate function must be a particle")
    }
    this.update()
  }
  ...
  gravitateStarCluster(cluster) {
    ...
    for (let i = 0; i < cluster.length; i++) {
      ...
      if (Particle.prototype.isPrototypeOf(star)) {
        ...
        throw new TypeError("The argument supplied to the gravitateStarCluster function must be an array of particles")
      }
    }
