...
THREE.SSAARenderPass.prototype = Object.assign(Object.create(THREE.Pass.prototype), {
  ...
  render (renderer, writeBuffer, readBuffer) {
    ...
    const jitterOffsets = THREE.SSAARenderPass.JitterVectors[Math.max(0, Math.min(this.sampleLevel, 5))]
    ...
    const width = readBuffer.width; const height = readBuffer.height
