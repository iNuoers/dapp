...
THREE.AdaptiveToneMappingPass.prototype = Object.assign(Object.create(THREE.Pass.prototype), {
  ...
  reset(renderer) {
    ...
    const pars = { minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat } // was RGB format. changed to RGBA format. see discussion in #8415 / #8450
