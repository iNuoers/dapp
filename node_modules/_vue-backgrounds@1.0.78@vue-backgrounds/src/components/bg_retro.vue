...
$mountain_wrap: rgba(255, 255, 255, 0.2);
$cold_ice_word: linear-gradient(#f3f3f3 20%, cyan);
$groundoverlay: radial-gradient(circle at top, rgba(0, 0, 0, 1.0), transparent 30%), linear-gradient(rgba(0, 0, 0, 0.7), transparent 50%);
