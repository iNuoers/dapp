...
<style lang="scss">
$mountain2: linear-gradient(to bottom, rgba(24, 26, 43, 1) 0%, rgba(57, 71, 105, 1) 73%, rgba(106, 96, 120, 1) 100%);
$mountain: linear-gradient(to bottom, rgba(9, 5, 19, 1) 0%, rgba(150, 73, 135, 1) 75%, rgba(253, 188, 163, 1) 100%);
@keyframes rotation {
  0% {
    transform: rotate(0)
  }
