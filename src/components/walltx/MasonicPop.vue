...
export default {
  ...
  computed: {
    ...
    free_amount () {
      return this.$store.getters["masonic/ready_for_withdrawal"]
    },
    allIncomeAmount () {
      return this.$store.getters["masonic/allIncomeAmount"]
    },
    // contract_balance
    dividendAmount () {
      return this.$store.getters["masonic/dividendAmount"]
    },
    recommendAmount () {
      return this.$store.getters["masonic/recommendAmount"]
    },
    waitToSend () {
      return this.$store.getters["masonic/waitToSend"]
    },
    lineAmount () {
      return this.$store.getters["masonic/lineAmount"]
    },
    keyAmount () {
      return this.$store.getters["masonic/myHackedKeyAmount"]
    }
  },
  methods: {
    clickredraw (e) {
