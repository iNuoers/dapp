    ...
    <ul class="page_header">
      ...
      <li class="coin_max_info">
        ...
        <div class="index_price">
          ...
          <div class="index_price_num"><p class="up"><div class="up_icon" /> $1,461.00 (2.42%) </p></div>
        </div>
                <!-- <div class="info_line" />
        <div class="index_price">
    ...
    <div class="app">
        ...
        <div class="left_body">
          <div class="borrow">
            <div class="borrow_title">
              <p class="borrow_title_text">Borrow</p><p class="borrow_title_info">MAX available:0 USDC</p>

              </div> 
                            <div class="borrow_input">
                              <input class="borrow_input_body" type="text" />
      ...
      <div class="exchange">
        ...
        <div class="exchange_line" />
                ...
                <div class="borrow">
            <div class="borrow_title">
              <p class="borrow_title_text">Buy</p><p class="borrow_title_info">MAX available:0 USDC</p>
