<template>
  <!--- speed code based on dribble https://dribbble.com/shots/6299660-Wallet-App --->
  <div class="container">
    <div class="iphone">
      <div class="header">
      ...
      <div class="content">
        ...
        <div class="transactions"><span class="t-desc">Recent Transactions</span>
          <div class="transaction">
            <div class="t-icon-container"><img
          ...
          <div class="transaction">
            <div class="t-icon-container"><img src="https://www.paypalobjects.com/webstatic/icon/pp144.png"
                                               class="t-icon"/></div>
            <div class="t-details">
