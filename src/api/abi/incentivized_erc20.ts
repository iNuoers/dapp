...
export enum IncentivizedERC20Events {
    Approval = 'Approval',
    Transfer = 'Transfer',
}

export interface IncentivizedERC20ApprovalEventArgs extends DecodedLogArgs {
    owner: string;
    spender: string;
    value: BN;
}

export interface IncentivizedERC20TransferEventArgs extends DecodedLogArgs {
    from: string;
    to: string;
    value: BN;
}
...
export type IncentivizedERC20EventArgs =
    | IncentivizedERC20ApprovalEventArgs
    | IncentivizedERC20TransferEventArgs;
...
export class IncentivizedERC20Contract extends BaseContract implements ContractInterface{
    /**
     * @ignore
     */
public static deployedBytecode: string | undefined;
public static readonly contractName = 'IncentivizedERC20';
    ...
    // @ts-ignore
    private readonly _subscriptionManager: SubscriptionManager<IncentivizedERC20EventArgs, IncentivizedERC20Events>;


    public static Instance(): (IncentivizedERC20Contract | any | boolean) {
        if (window && window.hasOwnProperty("__eth_contract_IncentivizedERC20")) {
          ...
          if (obj instanceof IncentivizedERC20Contract) {
            return (obj) as IncentivizedERC20Contract
          } else {
            return (obj) as IncentivizedERC20Contract
          }
        } else {
    ...
    static async init(
        ...
        ww3: Web3
        ):Promise<IncentivizedERC20Contract>
    {
        const contractInstance = await new IncentivizedERC20Contract(
            contract_address,
            supportedProvider,
            ww3
        );
...
"decimals"
    ...
    **/
    ...
    public async allowance(owner: string,spender: string,): Promise<BN> {
        const self = this as any as IncentivizedERC20Contract;
...
const result = await promizz.send({
    ...
    /**
     * Subscribe to an event type emitted by the IncentivizedERC20 contract.
     * @param eventName The IncentivizedERC20 contract event you would like to subscribe to.
     ...
     */
    public subscribe<ArgsType extends IncentivizedERC20EventArgs>(
        eventName: IncentivizedERC20Events,
     ...
     */
    public async getLogsAsync<ArgsType extends IncentivizedERC20EventArgs>(
        eventName: IncentivizedERC20Events,
